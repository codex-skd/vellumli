...
public class Book {
	...
	private static final Identifier DEFAULT_MODEL = Identifier.fromNamespaceAndPath(VellumliAPI.MOD_ID, "book_brown");
	private static final Identifier DEFAULT_BOOK_TEXTURE = Identifier.fromNamespaceAndPath(VellumliAPI.MOD_ID, "textures/gui/book_brown.png");
	private static final Identifier DEFAULT_FILLER_TEXTURE = Identifier.fromNamespaceAndPath(VellumliAPI.MOD_ID, "textures/gui/page_filler.png");
	private static final Identifier DEFAULT_CRAFTING_TEXTURE = Identifier.fromNamespaceAndPath(VellumliAPI.MOD_ID, "textures/gui/crafting.png");
	...
	public Book(JsonObject root, XplatModContainer owner, Identifier id, boolean external) {
		...
		this.openSound = SerializationUtil.getAsIdentifier(root, "open_sound", VellumliSounds.BOOK_OPEN.identifier());
		this.flipSound = SerializationUtil.getAsIdentifier(root, "flip_sound", VellumliSounds.BOOK_FLIP.identifier());
		...
		if (noBook) {
			...
			bookItem = Suppliers.memoize(() -> VellumliAPI.get().getBookStackTemplate(id));
		}
