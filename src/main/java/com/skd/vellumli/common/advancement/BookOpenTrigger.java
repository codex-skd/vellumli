...
/**
 * An advancement trigger for opening Vellumli books.
 */
public class BookOpenTrigger extends SimpleCriterionTrigger<BookOpenTrigger.TriggerInstance> {
	public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(VellumliAPI.MOD_ID, "open_book");
