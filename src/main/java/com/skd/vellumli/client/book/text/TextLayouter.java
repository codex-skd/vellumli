...
import com.skd.vellumli.api.VellumliConfigAccess.TextOverflowMode;
...
public class TextLayouter {
	...
	public void layout(Font font, List<Span> spans) {
		...
		} while (mode == VellumliConfigAccess.TextOverflowMode.RESIZE && getOverflow() * getScale() > 1 && adjustScale());
		// if TextOverflowMode is TRUNCATE, yeet everything below baseline
		if (mode == VellumliConfigAccess.TextOverflowMode.TRUNCATE) {
