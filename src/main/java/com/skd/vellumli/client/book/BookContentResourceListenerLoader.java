...
public class BookContentResourceListenerLoader extends SimpleJsonResourceReloadListener
	...
	public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(VellumliAPI.MOD_ID, "resource_pack_books");
	...
	private BookContentResourceListenerLoader() {
		super(BookRegistry.GSON, "vellumli_books");
	}
