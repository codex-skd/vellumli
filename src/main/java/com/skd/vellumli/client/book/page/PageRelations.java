...
public class PageRelations extends PageWithText {
	...
	public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float pticks) {
		parent.drawCenteredStringNoShadow(graphics, title == null || title.isEmpty() ? I18n.get("vellumli.gui.lexicon.relations") : i18n(title), GuiBook.PAGE_WIDTH / 2, 0, book.headerColor);
