...
import com.skd.vellumli.client.book.template.component.*;
...
public class BookTemplate {
	...
	static {
		registerComponent(ResourceLocation.fromNamespaceAndPath(VellumliAPI.MOD_ID, "text"), ComponentText.class);
		registerComponent(ResourceLocation.fromNamespaceAndPath(VellumliAPI.MOD_ID, "item"), ComponentItemStack.class);
		registerComponent(ResourceLocation.fromNamespaceAndPath(VellumliAPI.MOD_ID, "image"), ComponentImage.class);
		registerComponent(ResourceLocation.fromNamespaceAndPath(VellumliAPI.MOD_ID, "header"), ComponentHeader.class);
		registerComponent(ResourceLocation.fromNamespaceAndPath(VellumliAPI.MOD_ID, "separator"), ComponentSeparator.class);
		registerComponent(ResourceLocation.fromNamespaceAndPath(VellumliAPI.MOD_ID, "frame"), ComponentFrame.class);
		registerComponent(ResourceLocation.fromNamespaceAndPath(VellumliAPI.MOD_ID, "entity"), ComponentEntity.class);
		registerComponent(ResourceLocation.fromNamespaceAndPath(VellumliAPI.MOD_ID, "tooltip"), ComponentTooltip.class);
		registerComponent(ResourceLocation.fromNamespaceAndPath(VellumliAPI.MOD_ID, "custom"), ComponentCustom.class);
	}
