...
import com.skd.vellumli.client.book.page.*;
...
public class ClientBookRegistry {
	...
	private void addPageTypes() {
		pageTypes.put(ResourceLocation.fromNamespaceAndPath(VellumliAPI.MOD_ID, "text"), PageText.class);
		pageTypes.put(ResourceLocation.fromNamespaceAndPath(VellumliAPI.MOD_ID, "crafting"), PageCrafting.class);
		pageTypes.put(ResourceLocation.fromNamespaceAndPath(VellumliAPI.MOD_ID, "smelting"), PageSmelting.class);
		pageTypes.put(ResourceLocation.fromNamespaceAndPath(VellumliAPI.MOD_ID, "blasting"), PageBlasting.class);
		pageTypes.put(ResourceLocation.fromNamespaceAndPath(VellumliAPI.MOD_ID, "smoking"), PageSmoking.class);
		pageTypes.put(ResourceLocation.fromNamespaceAndPath(VellumliAPI.MOD_ID, "campfire"), PageCampfireCooking.class);
		pageTypes.put(ResourceLocation.fromNamespaceAndPath(VellumliAPI.MOD_ID, "smithing"), PageSmithing.class);
		pageTypes.put(ResourceLocation.fromNamespaceAndPath(VellumliAPI.MOD_ID, "stonecutting"), PageStonecutting.class);
		pageTypes.put(ResourceLocation.fromNamespaceAndPath(VellumliAPI.MOD_ID, "image"), PageImage.class);
		pageTypes.put(ResourceLocation.fromNamespaceAndPath(VellumliAPI.MOD_ID, "spotlight"), PageSpotlight.class);
		pageTypes.put(ResourceLocation.fromNamespaceAndPath(VellumliAPI.MOD_ID, "empty"), PageEmpty.class);
		// VELLUMLI NOTE (deferred in this beta): the "multiblock" page type (3D preview) is not ported yet.
		pageTypes.put(ResourceLocation.fromNamespaceAndPath(VellumliAPI.MOD_ID, "link"), PageLink.class);
		pageTypes.put(ResourceLocation.fromNamespaceAndPath(VellumliAPI.MOD_ID, "relations"), PageRelations.class);
		pageTypes.put(ResourceLocation.fromNamespaceAndPath(VellumliAPI.MOD_ID, "entity"), PageEntity.class);
		pageTypes.put(ResourceLocation.fromNamespaceAndPath(VellumliAPI.MOD_ID, "quest"), PageQuest.class);
	}
	...
	public static class LexiconPageAdapter implements JsonDeserializer<BookPage> {
		...
		public BookPage deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
			...
			if (string.indexOf(':') < 0) {
				string = VellumliAPI.MOD_ID + ":" + string;
			}
